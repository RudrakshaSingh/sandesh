...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white  bottom-0 w-full z-40">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-2xl font-bold">Sandesh</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/create-invitation" className="text-gray-400 hover:text-orange-500 transition">Create</Link>
              </li>
              <li>
                <Link to="/design" className="text-gray-400 hover:text-orange-500 transition">Design Library</Link>
              </li>
              <li>
