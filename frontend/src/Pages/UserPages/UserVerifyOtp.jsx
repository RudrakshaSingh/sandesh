...
const UserVerifyOtp = () => {
	...
	const handleSubmit = async (e) => {
		...
		if (enteredOtp.length === otp.length) {
			try {
        console.log("type",typeof enteredOtp);
        
				const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/users/verifyotp`, {
					email,
					otp: enteredOtp,
	...
	return (
		<div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
			<div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full">
				<h2 className="text-2xl font-bold text-gray-800 mb-2 text-center">OTP Verification</h2>
				<p className="text-gray-600 mb-8 text-center">Enter the 4-digit code sent to your email</p>
